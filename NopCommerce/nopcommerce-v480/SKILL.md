---
name: nopcommerce-v480
description: nopCommerce v4.80 plugin development conventions — architecture, permissions, scheduled tasks, localization, and error handling.
---

# nopCommerce v4.80 Rules

## When to Use

Activate this skill when:
- AGENTS.md specifies nopCommerce version 4.80
- Creating or modifying a plugin targeting nopCommerce v4.80
- Writing version-specific code (migrations, DI, controllers) for v4.80
...
### Resource Management
- Define resources in `GetPluginResources()` method of plugin class
- Use `ILocalizationService` for programmatic access
- Use `@T("Resource.Key")` in Razor views
